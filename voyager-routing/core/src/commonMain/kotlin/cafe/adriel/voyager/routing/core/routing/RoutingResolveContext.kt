...
import cafe.adriel.voyager.routing.core.application.path
import cafe.adriel.voyager.routing.core.plugins.BadRequestException
...
public class RoutingResolveContext(
    public val routing: VoyagerRoute,
     ...
     */
    public val hasTrailingSlash: Boolean = call.path().endsWith('/')
    ...
    private fun handleRoute(
        ...
        val hasHandlers = entry.handler != null
