...
internal class SnapshotStateStackTest {
    @TestFactory
    fun initSingle(): Sequence<DynamicTest> = sequenceOf(
        "item 1" to 0,
        "item 1" to 1,
    ).map { (item, minSize) ->
    ...
    @TestFactory
    fun initList(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun items(): Sequence<DynamicTest> = sequenceOf(
        emptyList(),
        listOf("item 1"),
    ...
    @TestFactory
    fun lastOrNull(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun size(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun isEmpty(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun canPop(): Sequence<DynamicTest> = sequenceOf(
        Triple(emptyList(), 0, false),
    ...
    @TestFactory
    fun pushSingle(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun pushList(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun replace(): Sequence<DynamicTest> = sequenceOf(
        emptyList<String>() to "new item",
        listOf("item 1") to "new item",
        listOf("item 1", "item 2") to "new item",
    ).map { (items, newItem) ->
    ...
    @TestFactory
    fun replaceAll(): Sequence<DynamicTest> = sequenceOf(
        emptyList<String>() to "new item",
        listOf("item 1") to "new item",
        listOf("item 1", "item 2") to "new item",
    ).map { (items, newItem) ->
    ...
    @TestFactory
    fun pop(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun popAll(): Sequence<DynamicTest> = sequenceOf(
    ...
    @TestFactory
    fun popUntil(): Sequence<DynamicTest> = sequenceOf(
